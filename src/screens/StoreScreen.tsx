            ...
            <div className="store-info">
              <div className="store-info-header">
                ...
                <div>
                  ...
                  <a
                    href={`https://api.whatsapp.com/send?phone=57${store[0].mobile}`}
                  >
              ...
              <div className="comments">
                <div className="comments-header">
                  <h3>
                    Comentarios <span>{store[0].comments.length}</span>{" "}
                  </h3>
                ...
                <div className="comments-list">
                  {store[0].comments
                    .filter((comment: any, index: any) => index < 5)
                    .map((comment: any) => (
      ...
      {openBooking && (
        <div className="menu-screen min-he">
          ...
          <div className="booking-container">
            {!loading &&
              store[0].chairs
                .filter((chair: any) => chair.amount > 0)
                .map((menu: any) => (
                  <button
                    key={menu._id}
