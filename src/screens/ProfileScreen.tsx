  ...
  return (
    <div>
      ...
      <div className="profile-shared">
        ...
        <p>
          Graba o sube un video con efectos, sonidos y mas. Tus videos
          apareceran en tu perfil.
        </p>
      ...
      <div className="danger">
        <button className="btn-danger" onClick={() => signoutHadler()}>
          Cerrar sesion
        </button>
      </div>
