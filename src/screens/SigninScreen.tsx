      ...
      <div className="home-container">
        ...
        <form action="" autoComplete='off'>
          <div className="input-form">
            ...
            <input className='input-login' type="text" placeholder='Usuario'  autoComplete='false'  value={username} onChange={(e) => setUsername(e.target.value)} />
          </div>
          <div className="input-form">
          <i className='bx bx-lock-alt' ></i>
          <input className='input-login' type="password" placeholder='Contrasena' value={password} onChange={(e) => setPassword(e.target.value)} />
          </div>
        ...
        <Link to="/register">No tienes una cuenta? <span>Registrate</span> </Link>
      </div>
    </div>
  )
}
